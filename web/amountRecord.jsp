                ...
                <div class="mui-content-padded" style="margin: 5px;">
                    <form class="mui-input-group" action="amountRecord.do">
                        <div class="mui-input-row">
                            <label>金额</label>
                            <input type="text" name="amount" class="mui-input-clear" placeholder="输入金额"
                                   pattern="[0-9]{4}">
                        </div>
                        <div class="mui-input-row">
                            <label>日期</label>
                        ...
                        <button type="button" id='dtSelect'
                                data-options='{"type":"date","beginYear":2019,"endYear":2022}'
